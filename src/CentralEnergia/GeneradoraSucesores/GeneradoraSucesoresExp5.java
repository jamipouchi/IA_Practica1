...
public class GeneradoraSucesoresExp5 implements SuccessorFunction {
    ...
    public List getSuccessors(Object arg0) {
        ...
        for (int idxCliente = 0; idxCliente < estadoActual.getAsignacionClientes().length; ++idxCliente) {
            ...
            if (nuevoEstado.desasignar_enswap(idxCliente)) {
        ...
        /*
         * // Operador swap
         * for (int idxCliente1 = 0; idxCliente1 <
         * estadoActual.getAsignacionClientes().length; ++idxCliente1) {
         * for (int idxCliente2 = idxCliente1 + 1; idxCliente2 <
         * estadoActual.getAsignacionClientes().length; ++idxCliente2) {
         * Estado nuevoEstado = new Estado(estadoActual);
